const buckets = [
    { id: 'options', prefix: '../data/SPYI-Files/SPYI_Options_-_Index_' },
    { id: 'cash',    prefix: '../data/SPYI-Files/SPYI_Cash_' },
    { id: 'stocks',  prefix: '../data/SPYI-Files/SPYI_Stocks_' }
];
...
fetch("../data/SPYI-Files/available_dates.json")
    .then(res => res.json())
    .then(data => {
